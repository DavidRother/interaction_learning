...
for t1, t2, t3, t4, t5, i1 in zip(task_1, task_2, task_3, task_4, task_5, impact_tasks_1):
    ...
    with open(f"ppo_other_agents/ppo_other_agent_{t3}", "rb") as input_file:
        other_agent_3 = pickle.load(input_file)

    with open(f"ppo_other_agents/ppo_other_agent_{t4}", "rb") as input_file:
        other_agent_4 = pickle.load(input_file)

    with open(f"ppo_other_agents/ppo_other_agent_{t5}", "rb") as input_file:
        other_agent_5 = pickle.load(input_file)
    ...
    evaluation_scores = [evaluate(env, 10, [interaction_agent, other_agent_2, other_agent_3,
                                            other_agent_4, other_agent_5], kwargs_agents=kwargs_agents)]
    eval_scores[algorithm][t1 + sum(*i1) + t2] = evaluation_scores
