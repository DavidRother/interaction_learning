...
tasks = ["ta2", "ta0", "tb2", "tc4", "te1"]
impact_tasks = ["ia2", "ia0", "ib2", "ic4", "ie1"]
...
with open("impact_learner/selected_tasks_5_agents.agent", "rb") as input_file:
...
with open("stats/training_selected_tasks_5_agents_stage_2.stats", 'wb') as outp:  # Overwrites any existing file.
    pickle.dump(stats, outp, pickle.HIGHEST_PROTOCOL)
interaction_agent.save_agent("impact_learner/selected_tasks_5_agents_2_stage.agent")
