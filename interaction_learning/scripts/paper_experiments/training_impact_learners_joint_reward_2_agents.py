...
with open("stats/training_impact_learners_joint_reward_2_agents.stats", 'wb') as outp:  # Overwrites any existing file.
    pickle.dump(stats, outp, pickle.HIGHEST_PROTOCOL)
interaction_agent.save_agent("impact_learner/joint_learner.agent")
