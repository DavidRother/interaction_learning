...
train_input1 = torch.from_numpy(y[3:, :-1])  # (97, 999)
train_target1 = torch.from_numpy(y[3:, 1:])  # (97, 999)

test_input1 = torch.from_numpy(y[:3, :-1])  # (3, 999)
test_target1 = torch.from_numpy(y[:3, 1:])  # (3, 999)

model1 = LSTM()
criterion1 = nn.MSELoss()
optimiser1 = optim.LBFGS(model1.parameters(), lr=0.08)

training_loop(10, model1, optimiser1, criterion1, train_input1, train_target1, test_input1, test_target1)
