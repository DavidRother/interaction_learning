...
interaction_tasks = [["tx", "iy0d"], ["tx", "iy1d"], ["tx", "iy2d"], ["tx", "iy3d"], ["tx", "iy4d"]]
...
with open("interaction_agents/all_tasks_with_interactions.agent", "rb") as input_file:
...
for interaction_task, task in zip(interaction_tasks, tasks):
    ...
    evaluation_scores = evaluate(env, 10, [interaction_agent, other_agent],
