...
# environment
num_agents = 1
agent_positions = lambda: [np.asarray([0.05, np.random.uniform(0.01, 0.99, 1).item()])]
agent_reward = ["x"]
max_steps = 1000
ghost_agents = 0
render = True
...
env = parallel_env(num_agents=num_agents, agent_positions=agent_positions, agent_reward=agent_reward,
...
agent_dir = "agents/"
idx = 0
agent_save_string = f"soft_agent{idx}_partigame.pickle"
# train
